...
namespace Beta.Data.MyCatSqlClient.Authentication
{
  internal partial class AuthenticationPluginManager
  {
    ...
    {
      Plugins["mysql_native_password"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.MySqlNativePasswordPlugin");
      Plugins["sha256_password"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.Sha256AuthenticationPlugin");
      Plugins["authentication_windows_client"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.MySqlWindowsAuthenticationPlugin");
      Plugins["caching_sha2_password"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.CachingSha2AuthenticationPlugin");
      Plugins["authentication_ldap_sasl_client"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.MySqlSASLPlugin");
      Plugins["mysql_clear_password"] = new PluginInfo("Beta.Data.MyCatSqlClient.Authentication.MySqlClearPasswordPlugin");
