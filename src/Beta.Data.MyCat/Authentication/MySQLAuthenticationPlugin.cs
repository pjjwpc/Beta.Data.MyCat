...
namespace Beta.Data.MyCatSqlClient.Authentication
{
  ...
  public abstract class MySqlAuthenticationPlugin
  {
    ...
    /// </summary>
    protected MyCatSqlConnectionStringBuilder Settings => _driver.Settings;
    ...
    internal void Authenticate(bool reset)
    {
      ...
      MyCatSqlPacket packet = _driver.Packet;
    ...
    private void WritePassword(MyCatSqlPacket packet)
    {
    ...
    private MyCatSqlPacket ReadPacket()
    {
      try
      {
        MyCatSqlPacket p = _driver.ReadPacket();
        return p;
      }
    ...
    private void HandleAuthChange(MyCatSqlPacket packet)
    {
