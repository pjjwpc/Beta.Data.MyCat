...
{
#if NET452
  [ToolboxBitmap(typeof(MyCatSqlConnection), "MySqlClient.resources.connection.bmp")]
#endif
  [DesignerCategory("Code")]
  [ToolboxItem(true)]
  public sealed partial class MyCatSqlConnection : DbConnection, ICloneable
  {
    /// <summary>
    ...
    /// <summary>
    /// Creates a new MyCatSqlConnection object with the exact same ConnectionString value
    /// </summary>
    /// <returns>A cloned MyCatSqlConnection object</returns>
    public object Clone()
    {
      MyCatSqlConnection clone = new MyCatSqlConnection();
      clone.IsClone = true;
