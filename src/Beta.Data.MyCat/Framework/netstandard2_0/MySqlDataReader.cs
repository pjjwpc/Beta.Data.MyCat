...
{
  public sealed partial class MyCatSqlDataReader : DbDataReader, IDataReader, IDataRecord
  {
    /// <summary>
    /// Returns a DataTable that describes the column metadata of the MyCatSqlDataReader.
    /// </summary>
    /// <returns></returns>
