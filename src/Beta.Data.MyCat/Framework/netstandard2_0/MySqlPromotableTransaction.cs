...
namespace Beta.Data.MyCatSqlClient
{
  ...
  {
    public MyCatSqlConnection connection;
    public Transaction baseTransaction;
    public MySqlTransaction simpleTransaction;
    public int rollbackThreadId;

    public MySqlTransactionScope(MyCatSqlConnection con, Transaction trans,
  ...
  internal sealed class MySqlPromotableTransaction : IPromotableSinglePhaseNotification, ITransactionPromoter
  {
    ...
    public MySqlPromotableTransaction(MyCatSqlConnection connection, Transaction baseTransaction)
    {
