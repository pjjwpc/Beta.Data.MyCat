...
namespace Beta.Data.MyCatSqlClient
{
  ...
  [Designer("Beta.Data.MyCatSqlClient.Design.MySqlDataAdapterDesigner,MySqlClient.Design")]
  public sealed class MySqlDataAdapter : DbDataAdapter, IDbDataAdapter, IDataAdapter
  {
    ...
    public MySqlDataAdapter(MyCatSqlCommand selectCommand)
      : this()
    {
    ...
    public MySqlDataAdapter(string selectCommandText, MyCatSqlConnection connection)
      : this()
    {
      SelectCommand = new MyCatSqlCommand(selectCommandText, connection);
    }
    ...
    public MySqlDataAdapter(string selectCommandText, string selectConnString)
      : this()
    {
      SelectCommand = new MyCatSqlCommand(selectCommandText,
        new MyCatSqlConnection(selectConnString));
    }
    ...
    public new MyCatSqlCommand DeleteCommand
    {
      get { return (MyCatSqlCommand)base.DeleteCommand; }
    ...
    public new MyCatSqlCommand InsertCommand
    {
      get { return (MyCatSqlCommand)base.InsertCommand; }
    ...
    [Category("Fill")]
    public new MyCatSqlCommand SelectCommand
    {
      get { return (MyCatSqlCommand)base.SelectCommand; }
    ...
    public new MyCatSqlCommand UpdateCommand
    {
      get { return (MyCatSqlCommand)base.UpdateCommand; }
    ...
    private void OpenConnectionIfClosed(DataRowState state,
      List<MyCatSqlConnection> openedConnections)
    {
      MyCatSqlCommand cmd = null;
      switch (state)
      {
    ...
    protected override int Update(DataRow[] dataRows, DataTableMapping tableMapping)
    {
      ...
      List<MyCatSqlConnection> connectionsOpened = new List<MyCatSqlConnection>();
      ...
      {
        foreach (MyCatSqlConnection c in connectionsOpened)
          c.Close();
      }
    }
    ...
    protected override int AddToBatch(IDbCommand command)
    {
      ...
      MyCatSqlCommand commandToBatch = (MyCatSqlCommand)command;
    ...
    protected override int ExecuteBatch()
    {
      ...
      {
        MyCatSqlCommand cmd = (MyCatSqlCommand)commandBatch[index++];
        for (int index2 = index; index2 < commandBatch.Count; index2++, index++)
        {
          MyCatSqlCommand cmd2 = (MyCatSqlCommand)commandBatch[index2];
    ...
    protected override void ClearBatch()
    {
      ...
      {
        MyCatSqlCommand cmd = (MyCatSqlCommand)commandBatch[0];
        if (cmd.Batch != null)
          cmd.Batch.Clear();
      }
      commandBatch.Clear();
  ...
  public sealed class MySqlRowUpdatingEventArgs : RowUpdatingEventArgs
  {
    ...
    /// <summary>
    /// Gets or sets the MyCatSqlCommand to execute when performing the Update.
    /// </summary>
    new public MyCatSqlCommand Command
    {
      get { return (MyCatSqlCommand)base.Command; }
  ...
  public sealed class MySqlRowUpdatedEventArgs : RowUpdatedEventArgs
  {
    ...
    /// <summary>
    /// Gets or sets the MyCatSqlCommand executed when Update is called.
    /// </summary>
    new public MyCatSqlCommand Command
    {
      get { return (MyCatSqlCommand)base.Command; }
