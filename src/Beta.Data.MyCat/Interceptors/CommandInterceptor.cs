...
namespace Beta.Data.MyCatSqlClient
{
  ...
  public abstract class BaseCommandInterceptor
  {
    ...
    /// </summary>
    protected MyCatSqlConnection ActiveConnection { get; private set; }
    ...
    /// <param name="returnValue">A <see cref="MyCatSqlDataReader"/> object containing the result of the statement execution.</param>
    /// <returns><c>false</c>.</returns>
    /// <remarks>This method is intended to be overriden.</remarks>
    public virtual bool ExecuteReader(string sql, CommandBehavior behavior, ref MyCatSqlDataReader returnValue)
    {
      return false;
    }
    ...
    public virtual void Init(MyCatSqlConnection connection)
    {
  ...
  internal sealed partial class CommandInterceptor : Interceptor
  {
    ...
    public CommandInterceptor(MyCatSqlConnection connection)
    {
    ...
    public bool ExecuteReader(string sql, CommandBehavior behavior, ref MyCatSqlDataReader returnValue)
    {
      if (_insideInterceptor) return false;
      _insideInterceptor = true;
