...
namespace Beta.Data.MyCatSqlClient
{
  ...
  public class MyCatSqlScript
  {
    ...
    /// <see cref="MyCatSqlScript"/> class.
    /// </summary>
    public MyCatSqlScript()
    {
      Delimiter = ";";
    }
    ...
    public MyCatSqlScript(MyCatSqlConnection connection)
      : this()
    {
    ...
    public MyCatSqlScript(string query)
      : this()
    {
      Query = query;
    }
    ...
    /// <param name="connection">The connection.</param>
    /// <param name="query">The query.</param>
    public MyCatSqlScript(MyCatSqlConnection connection, string query)
      : this()
    {
      Connection = connection;
      Query = query;
    ...
    public MyCatSqlConnection Connection { get; set; }
    ...
    public int Execute()
    {
      ...
      try
      {
        ...
        int count = 0;
        MyCatSqlCommand cmd = new MyCatSqlCommand(null, Connection);
