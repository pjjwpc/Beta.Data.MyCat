...
namespace Beta.Data.MyCatSqlClient
{
  ...
  internal class MyCatSqlStream
  {
    ...
    public MyCatSqlStream(Encoding encoding)
    {
      ...
      packet = new MyCatSqlPacket(encoding);
    }

    public MyCatSqlStream(Stream baseStream, Encoding encoding, bool compress)
      : this(encoding)
    {
...
#region Packet methods
    ...
    /// </summary>
    public MyCatSqlPacket ReadPacket()
    {
    ...
    public void SendPacket(MyCatSqlPacket packet)
    {
