...
namespace Beta.Data.Types
{
  ...
  internal struct MySqlBit : IMySqlValue
  {
    ...
    public void WriteValue(MyCatSqlPacket packet, bool binary, object value, int length)
    {
    ...
    public IMySqlValue ReadValue(MyCatSqlPacket packet, long length, bool isNull)
    {
      this.IsNull = isNull;
      if (isNull)
        return this;
    ...
    public void SkipValue(MyCatSqlPacket packet)
    {
