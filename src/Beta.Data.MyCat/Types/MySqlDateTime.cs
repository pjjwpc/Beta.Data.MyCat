...
namespace Beta.Data.Types
{
  ...
  public struct MySqlDateTime : IMySqlValue, IComparable, IConvertible
  {
    ...
    private void SerializeText(MyCatSqlPacket packet, MySqlDateTime value)
    {
    ...
    void IMySqlValue.WriteValue(MyCatSqlPacket packet, bool binary, object value, int length)
    {
