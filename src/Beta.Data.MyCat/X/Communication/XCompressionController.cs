...
namespace MySqlX.Communication
{
  ...
  internal class XCompressionController
  {
    ...
    internal static void LoadLibzstdLibrary()
    {
      ...
      LibZstdLoaded = UnmanagedLibraryLoader.LoadUnmanagedLibraryFromEmbeddedResources("Beta.Data", "libzstd.dll");
      ...
      if (LibZstdLoaded == false)
      {
        MyCatSqlTrace.LogWarning(-1, ResourcesX.CompressionFailedToLoadLibzstdAssembly);
      }
    }
  }
}
