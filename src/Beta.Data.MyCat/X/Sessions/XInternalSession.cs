...
namespace MySqlX.Sessions
{
  ...
  internal class XInternalSession : InternalSession
  {
    ...
    protected override void Open()
    {
      ...
      bool isUnix = Settings.ConnectionProtocol == MyCatSqlConnectionProtocol.Unix ||
        Settings.ConnectionProtocol == MyCatSqlConnectionProtocol.UnixSocket;
    ...
    internal void Authenticate()
    {
      ...
      {
        if ((Settings.SslMode != MySqlSslMode.None && serverSupportsTls) || Settings.ConnectionProtocol == MyCatSqlConnectionProtocol.Unix)
        {
    ...
    private Dictionary<string, object> NegotiateCompression(string[] serverSupportedAlgorithms,string[] clientAgainstUserAlgorithms)
    {
      ...
      if (!clientAgainstUserAlgorithms.Any(element => serverSupportedAlgorithms.Contains(element)))
        ...
        {
          MyCatSqlTrace.LogWarning(-1, ResourcesX.CompressionAlgorithmNegotiationFailed);
          return null;
        }
