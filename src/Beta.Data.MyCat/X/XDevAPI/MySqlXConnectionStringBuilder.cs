...
namespace MySqlX.XDevAPI
{
  ...
  /// </summary>
  public sealed class MySqlXConnectionStringBuilder : MyCatSqlBaseConnectionStringBuilder
  {
    static MySqlXConnectionStringBuilder()
    {
      ...
      // Server options.
      Options.Add(new MyCatSqlConnectionStringOption("connect-timeout", "connecttimeout", typeof(uint), (uint)10000, false,
        delegate (MySqlXConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender, object Value)
        {
      ...
      Options.Add(new MyCatSqlConnectionStringOption("connection-attributes", "connectionattributes", typeof(string), "true", false,
        (msb, sender, value) => { msb.SetValue("connection-attributes", value); }, (msb, sender) => msb.ConnectionAttributes));
      Options.Add(new MyCatSqlConnectionStringOption("compression", "use-compression", typeof(CompressionType), CompressionType.Preferred, false,
        (msb, sender, value) => { msb.SetValue("compression", value); }, (msb, sender) => msb.Compression));
      Options.Add(new MyCatSqlConnectionStringOption("compression-algorithms", "compressionalgorithms", typeof(string), string.Empty, false,
              (msb, sender, value) => { msb.SetValue("compression-algorithms", value); }, (msb, sender) => msb.CompressionAlgorithm));
      
      // Authentication options.
      Options.Add(new MyCatSqlConnectionStringOption("auth", null, typeof(MySqlAuthenticationMode), MySqlAuthenticationMode.Default, false,
        (msb, sender, value) => { msb.SetValue("auth", value); }, (msb, sender) => msb.Auth));
      Options.Add(new MyCatSqlConnectionStringOption("sslcrl", "ssl-crl", typeof(string), null, false,
