...
{
  /// <include file='docs/MyCatSqlCommand.xml' path='docs/ClassSummary/*'/> 
  public sealed partial class MyCatSqlCommand : DbCommand, IDisposable
  {
    MyCatSqlConnection connection;
    string cmdText;
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ctor1/*'/>
    public MyCatSqlCommand()
    {
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ctor2/*'/>
    public MyCatSqlCommand(string cmdText)
      : this()
    {
      CommandText = cmdText;
    }

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ctor3/*'/>
    public MyCatSqlCommand(string cmdText, MyCatSqlConnection connection)
      : this(cmdText)
    {
      Connection = connection;
    }

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ctor4/*'/>
    public MyCatSqlCommand(string cmdText, MyCatSqlConnection connection, MySqlTransaction transaction)
    ...
    /// </summary>
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/LastInseredId/*'/>
    [Browsable(false)]
    public Int64 LastInsertedId { get; internal set; }

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/CommandText/*'/>
    [Category("Data")]
    [Description("Command text to execute")]
#if NET452
    [Editor("Beta.Data.Common.Design.SqlCommandTextEditor,MySqlClient.Design", typeof(System.Drawing.Design.UITypeEditor))]
#endif
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/CommandTimeout/*'/>
    [Category("Misc")]
    ...
    public override int CommandTimeout
    {
      ...
      set
      {
        ...
        if (timeout != value)
        {
          MyCatSqlTrace.LogWarning(connection.ServerThread,
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/CommandType/*'/>
    [Category("Data")]
    ...
    /// </summary>
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/IsPrepared/*'/>
    [Browsable(false)]
    public bool IsPrepared => statement != null && statement.IsPrepared;

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/Connection/*'/>
    [Category("Behavior")]
    [Description("Connection used by the command")]
    public new MyCatSqlConnection Connection
    {
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/Parameters/*'/>
    [Category("Data")]
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/Transaction/*'/>
    [Browsable(false)]
    ...
    internal List<MyCatSqlCommand> Batch { get; private set; }
    ...
    {
      get { return Connection; }
      set { Connection = (MyCatSqlConnection)value; }
    }
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ExecuteNonQuery/*'/>
    public override int ExecuteNonQuery()
    {
      ...
      using (MyCatSqlDataReader reader = ExecuteReader())
      {
        reader.Close();
    ...
    internal void Close(MyCatSqlDataReader reader)
    {
    ...
    internal void ResetSqlSelectLimit()
    {
      ...
      MyCatSqlCommand command = new MyCatSqlCommand("SET SQL_SELECT_LIMIT=DEFAULT", connection);
      command.InternallyCreated = true;
      command.ExecuteNonQuery();
    }

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ExecuteReader/*'/>
    public new MyCatSqlDataReader ExecuteReader()
    {
      return ExecuteReader(CommandBehavior.Default);
    }


    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ExecuteReader1/*'/>
    public new MyCatSqlDataReader ExecuteReader(CommandBehavior behavior)
    {

      // give our interceptors a shot at it first
      MyCatSqlDataReader interceptedReader = null;
      ...
      lock (driver)
      {
        ...
        try
        {
          MyCatSqlDataReader reader = new MyCatSqlDataReader(this, statement, behavior);
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/ExecuteScalar/*'/>
    ...
    private void HandleCommandBehaviors(CommandBehavior behavior)
    {
      ...
      {
        new MyCatSqlCommand("SET SQL_SELECT_LIMIT=0", connection).ExecuteNonQuery();
        resetSqlSelect = true;
      }
      else if ((behavior & CommandBehavior.SingleRow) != 0)
      {
        new MyCatSqlCommand("SET SQL_SELECT_LIMIT=1", connection).ExecuteNonQuery();
        resetSqlSelect = true;
      }
    }

    /// <include file='docs/MyCatSqlCommand.xml' path='docs/Prepare2/*'/>
    ...
    /// <include file='docs/MyCatSqlCommand.xml' path='docs/Prepare/*'/>
    ...
    /// that is described by this <see cref="MyCatSqlCommand"/>, and retrieves one or more 
    ...
    /// which returns a <see cref="MyCatSqlDataReader"/> instance that can be used to retrieve 
    ...
    /// <summary>
    /// Initiates the asynchronous execution of the SQL statement or stored procedure 
    /// that is described by this <see cref="MyCatSqlCommand"/> using one of the 
    ...
    /// <see cref="MyCatSqlDataReader"/>.
    /// </summary>
    /// <param name="result">The <see cref="IAsyncResult"/> returned by the call to 
    /// <see cref="BeginExecuteReader()"/>.</param>
    /// <returns>A <b>MyCatSqlDataReader</b> object that can be used to retrieve the requested rows. </returns>
    public MyCatSqlDataReader EndExecuteReader(IAsyncResult result)
    {
      ...
      return (MyCatSqlDataReader)c.EndInvoke(result);
    }

    /// <summary>
    /// Initiates the asynchronous execution of the SQL statement or stored procedure 
    /// that is described by this <see cref="MyCatSqlCommand"/>. 
    /// </summary>
    /// <param name="callback">
    ...
    internal void AddToBatch(MyCatSqlCommand command)
    {
      if (Batch == null)
        Batch = new List<MyCatSqlCommand>();
      Batch.Add(command);
    }
    ...
    internal string GetCommandTextForBatching()
    {
      if (BatchableCommandText == null)
      {
        ...
        {
          MyCatSqlCommand cmd = new MyCatSqlCommand("SELECT @@sql_mode", Connection);
