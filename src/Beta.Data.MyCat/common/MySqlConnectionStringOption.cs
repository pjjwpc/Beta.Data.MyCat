...
namespace Beta.Data.Common
{
  internal class MyCatSqlConnectionStringOption
  {
    public MyCatSqlConnectionStringOption(string keyword, string synonyms, Type baseType, object defaultValue, bool obsolete,
    ...
    public MyCatSqlConnectionStringOption(string keyword, string synonyms, Type baseType, object defaultValue, bool obsolete) :
      this(keyword, synonyms, baseType, defaultValue, obsolete,
       delegate (MyCatSqlBaseConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender, object value)
       {
    ...
    public delegate void SetterDelegate(MyCatSqlBaseConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender, object value);

    public delegate object GetterDelegate(MyCatSqlBaseConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender);

    public delegate void ClassicSetterDelegate(MyCatSqlConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender, object value);

    public delegate object ClassicGetterDelegate(MyCatSqlConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender);

    public delegate void XSetterDelegate(MySqlXConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender, object value);

    public delegate object XGetterDelegate(MySqlXConnectionStringBuilder msb, MyCatSqlConnectionStringOption sender);
