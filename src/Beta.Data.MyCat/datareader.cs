...
{
  /// <include file='docs/MyCatSqlDataReader.xml' path='docs/ClassSummary/*'/>
  public sealed partial class MyCatSqlDataReader : DbDataReader, IDataReader, IDataRecord, IDisposable
  {
     ...
     * marked as internal.
     */
    internal MyCatSqlDataReader(MyCatSqlCommand cmd, PreparableStatement statement, CommandBehavior behavior)
    {
      this.Command = cmd;
    ...
    internal MyCatSqlCommand Command { get; private set; }
    ...
    /// <summary>
    /// Gets a value indicating whether the MyCatSqlDataReader contains one or more rows.
    /// </summary>
    ...
    /// In C#, this property is the indexer for the MyCatSqlDataReader class.
    /// </summary>
    public override object this[int i] => GetValue(i);

    /// <summary>
    /// Gets the value of a column in its native format.
    ///	[C#] In C#, this property is the indexer for the MyCatSqlDataReader class.
    /// </summary>
    ...
    /// <summary>
    /// Closes the MyCatSqlDataReader object.
    /// </summary>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='MyDocs/MyMembers[@name="GetBytes"]/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetMySqlDateTime/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDateTimeS/*'/>
    public DateTime GetDateTime(string column)
    {
      return GetDateTime(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDateTime/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDecimalS/*'/>
    public Decimal GetDecimal(string column)
    {
      return GetDecimal(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDecimal/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDoubleS/*'/>
    public double GetDouble(string column)
    {
      return GetDouble(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetDouble/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetFloatS/*'/>
    public float GetFloat(string column)
    {
      return GetFloat(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetFloat/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetGuid/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt16S/*'/>
    public Int16 GetInt16(string column)
    {
      return GetInt16(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt16/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt32S/*'/>
    public Int32 GetInt32(string column)
    {
      return GetInt32(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt32/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt64S/*'/>
    public Int64 GetInt64(string column)
    {
      return GetInt64(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetInt64/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetStringS/*'/>
    public string GetString(string column)
    {
      return GetString(GetOrdinal(column));
    }

    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetString/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetTimeSpan/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetUInt16/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetUInt32/*'/>
    ...
    /// <include file='docs/MyCatSqlDataReader.xml' path='docs/GetUInt64/*'/>
    ...
    /// <summary>
    /// Advances the MyCatSqlDataReader to the next record.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns an <see cref="IEnumerator"/> that iterates through the <see cref="MyCatSqlDataReader"/>. 
    /// </summary>    
    ...
    private void ClearKillFlag()
    {
      ...
      MyCatSqlCommand dummyCommand = new MyCatSqlCommand(dummyStatement, _connection) { InternallyCreated = true };
