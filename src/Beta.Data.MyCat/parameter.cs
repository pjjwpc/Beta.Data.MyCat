...
{
  /// <summary>
  /// Represents a parameter to a <see cref="MyCatSqlCommand"/>, This class cannot be inherited.
  /// </summary>
  ...
  public sealed partial class MySqlParameter : DbParameter, IDbDataParameter
  {
    ...
    internal void Serialize(MyCatSqlPacket packet, bool binary, MyCatSqlConnectionStringBuilder settings)
    {
