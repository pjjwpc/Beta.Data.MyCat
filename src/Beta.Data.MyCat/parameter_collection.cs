...
{
  /// <summary>
  /// Represents a collection of parameters relevant to a <see cref="MyCatSqlCommand"/> as well as their respective mappings to columns in a <see cref="System.Data.DataSet"/>. This class cannot be inherited.
  /// </summary>
  ...
  public sealed partial class MySqlParameterCollection : DbParameterCollection
  {
    ...
    internal MySqlParameterCollection(MyCatSqlCommand cmd)
    {
