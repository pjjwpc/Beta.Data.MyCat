...
namespace Beta.Data.MyCatSqlClient
{
  ...
  public sealed class MySqlTransaction : DbTransaction
  {
    ...
    internal MySqlTransaction(MyCatSqlConnection c, IsolationLevel il)
    {
      Connection = c;
      IsolationLevel = il;
      open = true;
    ...
    /// <summary>
    /// Gets the <see cref="MyCatSqlConnection"/> object associated with the transaction, or a null reference (Nothing in Visual Basic) if the transaction is no longer valid.
    /// </summary>
    /// <value>The <see cref="MyCatSqlConnection"/> object associated with this transaction.</value>
    /// <remarks>
    ...
    /// transaction created by <see cref="MyCatSqlConnection.BeginTransaction()"/>.
    /// </remarks>
    public new MyCatSqlConnection Connection { get; }
    ...
    public override void Commit()
    {
      ...
      MyCatSqlCommand cmd = new MyCatSqlCommand("COMMIT", Connection);
      cmd.ExecuteNonQuery();
      open = false;
    }
    ...
    public override void Rollback()
    {
      ...
      MyCatSqlCommand cmd = new MyCatSqlCommand("ROLLBACK", Connection);
      cmd.ExecuteNonQuery();
      open = false;
    }
